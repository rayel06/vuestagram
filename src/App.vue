<template>
  <div class="header">
    ...
    <Container :img="img" :data="data" :step="step" @writeValue="write = $event" :filterSelected="filterSelected"/>
...
<script>
  ...
  export default {
    ...
    methods: {
      more(){
        axios.get(`https://codingapple1.github.io/vue/more${this.clicked}.json`)
        .then((result)=>{
